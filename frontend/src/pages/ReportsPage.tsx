    ...
    <div style={{ maxWidth: 1200, margin: "0 auto" }}>
      ...
      <div className="rp-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16, marginBottom: 24 }}>
        <div className="liquid-glass-card" style={{ padding: "18px 20px", borderColor: "rgba(96,165,250,0.25)" }}>
          ...
          <div style={{ fontSize: 24, fontWeight: 800, color: "var(--accent-blue)", marginTop: 6 }}>4h 22m</div>
          <div style={{ color: "var(--accent-blue)", fontSize: 11, marginTop: 4, display: "flex", alignItems: "center", gap: 4 }}>
        ...
        <div className="liquid-glass-card" style={{ padding: "18px 20px", borderColor: "rgba(251,191,36,0.25)" }}>
          <div style={{ color: "var(--text-muted)", fontSize: 12 }}>Conflict Frequency</div>
          <div style={{ fontSize: 24, fontWeight: 800, color: "var(--accent-amber)", marginTop: 6 }}>1.2 / day</div>
          <div style={{ color: "var(--accent-green)", fontSize: 11, marginTop: 4, display: "flex", alignItems: "center", gap: 4 }}>
        ...
        <div className="liquid-glass-card" style={{ padding: "18px 20px", borderColor: "rgba(167,139,250,0.25)" }}>
          <div style={{ color: "var(--text-muted)", fontSize: 12 }}>Peak Utilization Time</div>
          <div style={{ fontSize: 24, fontWeight: 800, color: "var(--accent-violet)", marginTop: 6 }}>08:15 AM</div>
          <div style={{ color: "var(--text-muted)", fontSize: 11, marginTop: 4 }}>Morning arrival window</div>
        </div>
      </div>
    </div>
  );
